...
class Tree {
   public static void main(String[] args) {
      ...
      infix(i);
      System.out.println("\nValue: " + eval(i));
      System.out.print("Height of tree: " + height(i));
   }

   // compute th height of a binary tre
   public static int height(Node node) {
      if (node == null)
         ...
         if (leftHeight > rightHeight)
            return leftHeight + 1; // if the taller subtree is left then return left subtree + 1(root of tree)
         else
            return rightHeight + 1; // if the taller subtree is right then return right subtree + 1(root of tree)
      }
   }
