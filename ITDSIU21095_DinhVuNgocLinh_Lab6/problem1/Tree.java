...
class Tree {
   public static void main(String[] args) {
      ...
      infix(i);
      System.out.println("\nValue: " + eval(i));
      System.out.print("Num of ele: " + counter(i));
   }

   // count element in a binary tree
   public static int counter(Node node) {
      if (node == null)
         return 0;
      else
         return 1 + counter(node.leftChild) + counter(node.rightChild);
   }
